...
{
    public partial class DialogSua : Form
    {
        public DialogSua()
        {
            InitializeComponent();
        ...
        private void DialogSua_Load(object sender, EventArgs e)
        {
            //auto load listbox1
            for (int i = 1; i < 20; i++)
            {
            ...
            textBox1.Text = "Sài gòn -> Nha Trang";
            textBox2.Text = "2.000";
        ...
        private void textBox2_giaTour(object sender, EventArgs e)
        {
